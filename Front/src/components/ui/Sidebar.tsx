...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "hidden h-full w-[300px] shrink-0 bg-[#056b66] px-4 py-4 text-white md:flex md:flex-col dark:bg-neutral-800",
          className,
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex h-10 w-full flex-row items-center justify-between bg-[#056b66] px-4 py-4 md:hidden dark:bg-neutral-800",
        )}
        {...props}
      >
        <div className="z-20 flex w-full justify-end"></div>
        <AnimatePresence>
          {open && (
            <motion.div
